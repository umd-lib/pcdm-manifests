...
module IIIF
  ...
  class FcrepoTest < ActiveSupport::TestCase
    test 'simple path' do
      path = IIIF::Fcrepo::Path.from_abbreviated('a:b:c')
    ...
    test 'flat style' do
      path = IIIF::Fcrepo::Path.from_abbreviated('pcdm::1d8a71b8-7356-4282-8e99-da88f0f997c7')
      assert_equal 'pcdm/1d/8a/71/b8/1d8a71b8-7356-4282-8e99-da88f0f997c7', path.to_s
    ...
    test 'hierarchical style' do
      path = IIIF::Fcrepo::Path.from_abbreviated('dc:2021:1::1d8a71b8-7356-4282-8e99-da88f0f997c7')
      assert_equal 'dc/2021/1/1d/8a/71/b8/1d8a71b8-7356-4282-8e99-da88f0f997c7', path.to_s
    ...
    test 'hierarchical style with sub-path' do
      path = IIIF::Fcrepo::Path.from_abbreviated('dc:2021:1::1d8a71b8-7356-4282-8e99-da88f0f997c7:m:IQMYmY-R')
      assert_equal 'dc/2021/1/1d/8a/71/b8/1d8a71b8-7356-4282-8e99-da88f0f997c7/m/IQMYmY-R', path.to_s
